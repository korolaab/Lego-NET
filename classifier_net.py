...
x_train,y_train = LOAD.load("photos")   #load photos and answers 
...
Drop3 = Dropout(0.2,name = "drop3")(Dens1)

Dens2 = Dense(256,activation = "relu",name = "dens2")(Drop3)
Drop4 = Dropout(0.2,name = "drop4")(Dens2)
